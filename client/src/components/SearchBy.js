  ...
  return (
    <div className="flex gap-x-4 px-8">
      <div className="cursor-pointer ">
        <div id="searchbycy" className="w-[100px] h-[50px] rounded-lg shadow-lg bg-white flex flex-col justify-center items-center hover:bg-dropdownhover" onClick={toggleSearchByDD}>
          Search By:
        </div>
