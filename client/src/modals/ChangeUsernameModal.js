    ...
    return (
      <div className="fixed inset-x-0 inset-y-0 flex items-center justify-center">
        ...
        <div className="bg-brownshade-700 border-modalborder border-solid border rounded-lg min-w-[350px] text-left">
          ...
          <input className="w-[350px] h-[35px] rounded-lg shadow-lg bg-transparent outline-none border-solid border pborder-lightgrey text-base mx-6 pl-2" type="text" placeholder="Username" onChange={handleChange} required></input>
          <br></br><br></br>
